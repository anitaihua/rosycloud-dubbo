...
public class Constants {
     ...
     * 人员类型
     */
    public static final Integer User_Normal=1;//正常
    public static final Integer User_Forbidden=0;//禁用
    public static final Integer User_ADMIN=-1;//超级管理员
     ...
     * 删除
     */
    public static final Integer Delete_Forbidden=1;
    /**
     * 正常
     */
    public static final Integer Delete_Normal=0;
